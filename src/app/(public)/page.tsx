...
export default function AAEnterpriseTechHomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 selection:bg-purple-500 selection:text-white antialiased overflow-x-hidden relative">
      {/* 🌟 Interactive Cursor Follow Ambient Light */}
      <div
        className="fixed w-[450px] h-[450px] rounded-full bg-gradient-to-r from-purple-600/20 via-indigo-500/15 to-blue-500/10 blur-[100px] pointer-events-none z-0 transition-transform duration-100 ease-out hidden md:block"
        style={{
      ...
      <section className="relative pt-28 sm:pt-36 md:pt-44 pb-16 sm:pb-24 overflow-hidden px-4 sm:px-6 z-10">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/50 border border-purple-500/40 text-xs font-bold text-purple-300 mb-6 sm:mb-8 shadow-lg shadow-purple-950/40 animate-float">
          ...
          <p className="text-sm sm:text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed font-normal px-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto pt-6 border-t border-slate-800/80">
            <div className="p-3.5 sm:p-4 rounded-2xl glass-card text-center hover:scale-105 transition-transform">
              ...
              <div className="text-[11px] sm:text-xs text-slate-400 font-medium mt-0.5">Client Satisfaction</div>
            </div>
            <div className="p-3.5 sm:p-4 rounded-2xl glass-card text-center hover:scale-105 transition-transform">
              <div className="text-xl sm:text-2xl font-black text-indigo-400">5-7 Days</div>
              <div className="text-[11px] sm:text-xs text-slate-400 font-medium mt-0.5">Average Turnaround</div>
            </div>
            <div className="p-3.5 sm:p-4 rounded-2xl glass-card text-center hover:scale-105 transition-transform">
              <div className="text-xl sm:text-2xl font-black text-blue-400">20+ Hrs</div>
              <div className="text-[11px] sm:text-xs text-slate-400 font-medium mt-0.5">AI Weekly Time Saved</div>
            </div>
            <div className="p-3.5 sm:p-4 rounded-2xl glass-card text-center hover:scale-105 transition-transform">
              <div className="text-xl sm:text-2xl font-black text-emerald-400">24/7</div>
              <div className="text-[11px] sm:text-xs text-slate-400 font-medium mt-0.5">Priority Support</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 border-y border-slate-800/80 bg-slate-950/60 overflow-hidden relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-wrap items-center justify-center gap-6 sm:gap-12 text-xs sm:text-sm font-semibold text-slate-400">
          <span className="text-slate-500 uppercase tracking-widest text-[11px]">Powered By Modern Tech:</span>
          <span className="flex items-center gap-1.5 text-slate-300"><Code2 className="w-4 h-4 text-purple-400" /> Next.js 14</span>
          <span className="flex items-center gap-1.5 text-slate-300"><Bot className="w-4 h-4 text-blue-400" /> OpenAI & Claude</span>
          <span className="flex items-center gap-1.5 text-slate-300"><Zap className="w-4 h-4 text-amber-400" /> n8n Automation</span>
          <span className="flex items-center gap-1.5 text-slate-300"><Globe className="w-4 h-4 text-indigo-400" /> Stripe Payments</span>
          <span className="flex items-center gap-1.5 text-slate-300"><Cpu className="w-4 h-4 text-emerald-400" /> Vercel Cloud</span>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-2 sm:mt-3">Tailored services engineered to deliver real-world business results.</p>
          </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-slate-300 mb-3 font-medium">{svc.name}</p>
                    <p className="text-xs text-slate-400 leading-relaxed mb-4">{svc.desc}</p>
                  </div>
                  <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between">
                    <span className="text-xs font-bold text-purple-400">From ${svc.price} USD</span>
                    <a
                      href="#contact"
                      onClick={(e) => scrollToSection(e, 'contact')}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-2 sm:mt-3">A transparent, agile process designed for rapid execution and flawless delivery.</p>
          </div>
            ...
            {steps.map((s, idx) => {
              ...
              return (
                <div key={idx} className="p-6 rounded-2xl glass-card border border-slate-800 hover:border-purple-500/50 transition-all relative group hover:-translate-y-1">
                  <div className="text-3xl font-black text-slate-800 group-hover:text-purple-500/40 transition-colors mb-3">
                    {s.step}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Professional Quality</h4>
                <p className="text-xs sm:text-sm text-slate-400">Enterprise-grade standards across code, visual design, and software reliability.</p>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Fast Turnaround</h4>
                <p className="text-xs sm:text-sm text-slate-400">Agile sprints and rapid delivery to help you launch ahead of competitors.</p>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Custom Solutions</h4>
                <p className="text-xs sm:text-sm text-slate-400">Tailored software stacks and workflows engineered for your exact business goals.</p>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Secure & Reliable</h4>
                <p className="text-xs sm:text-sm text-slate-400">Bank-grade SSL encryption, secure API protocols, and robust infrastructure.</p>
              </div>
            </div>

            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-pink-500/10 text-pink-400 flex items-center justify-center shrink-0">
                <Globe className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Worldwide Remote Service</h4>
                <p className="text-xs sm:text-sm text-slate-400">Serving enterprise clients, startups, and founders across the USA, UK, UAE, and worldwide.</p>
              </div>
            </div>
            ...
            <div className="p-5 sm:p-6 rounded-2xl glass-card border border-slate-800 flex items-start gap-4 hover:-translate-y-1 transition-transform">
              ...
              <div>
                <h4 className="font-bold text-white text-base sm:text-lg mb-1">Dedicated Support</h4>
                <p className="text-xs sm:text-sm text-slate-400">Direct communication via Slack/WhatsApp and responsive post-launch maintenance.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-slate-900/80 border border-purple-500/40 text-center relative overflow-hidden shadow-2xl shadow-purple-950/40">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mb-6 sm:mb-8">Select the services you need for an instant estimated investment figure.</p>
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-[10px] sm:text-xs font-bold text-purple-400 uppercase tracking-wider">{svc.category}</span>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-xs font-bold uppercase tracking-wider text-purple-400">Questions & Answers</span>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div key={idx} className="rounded-2xl glass-panel border border-slate-800 overflow-hidden">
                ...
                {openFaq === idx && (
                  <div className="px-5 sm:px-6 pb-6 text-slate-300 text-xs sm:text-sm border-t border-slate-800/60 pt-4 leading-relaxed animate-in fade-in duration-200">
                    {faq.a}
                  </div>
                )}
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-stretch">
            ...
            <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl glass-panel border border-slate-800 flex flex-col justify-between shadow-xl">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-slate-300 mt-2">
                <a
                  href="tel:+13148340021"
                ...
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-purple-500/10 text-purple-400 flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
                    <Phone className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <div>
                    <div className="text-[11px] sm:text-xs text-slate-400">Direct US Business Line</div>
                ...
                >
                  ...
                  <div>
                    <div className="text-[11px] sm:text-xs text-slate-400">Official Business Email</div>
                ...
                <div className="flex items-center gap-3.5 sm:gap-4 p-3.5 sm:p-4 rounded-2xl glass-card border border-slate-800">
                  ...
                  <div>
                    <div className="text-[11px] sm:text-xs text-slate-400">Headquarters & Global Presence</div>
            ...
            <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl glass-panel border border-slate-800 flex flex-col justify-between shadow-xl">
              <div>
                ...
                <p className="text-xs text-slate-400 mb-4">Fill in your requirements below for a fixed-price proposal.</p>
              </div>
      ...
      <footer className="border-t border-slate-800/80 py-10 sm:py-14 bg-slate-950 text-slate-400 text-xs sm:text-sm px-4 sm:px-6 relative z-10">
        <div className="max-w-7xl mx-auto space-y-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            >
              ...
              <div>
                ...
                <span className="block text-[10px] sm:text-[11px] text-slate-500">Digital Solutions & AI Automation Agency</span>
              </div>
            </Link>
          ...
          <div className="pt-6 border-t border-slate-850 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <Link href="/pay" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors">Client Payment Portal</Link>
            </div>
          </div>
        </div>
      </footer>
