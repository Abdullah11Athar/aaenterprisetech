    ...
    const performScroll = () => {
      ...
      if (el) {
        if (id === 'contact' && window.innerWidth < 768) {
          ...
          let targetTop = elementTop - headerOffset;
          
          if (window.innerWidth >= 768 && elementHeight < viewportHeight - 80) {
            const extraPadding = (viewportHeight - 70 - elementHeight) / 2;
            targetTop = Math.max(0, elementTop - 70 - extraPadding);
          }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 selection:bg-purple-500 selection:text-white antialiased overflow-x-hidden relative">
      ...
      <main id="main-content" className="flex-1">
        ...
        <section
          id="services"
          className={`py-6 sm:py-8 lg:py-10 px-4 sm:px-6 relative z-10 scroll-mt-20 transition-all duration-700 ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
              {servicesList.map((svc) => {
                ...
                return (
                  <div
                    key={svc.id}
                    className={`p-4 sm:p-5 rounded-2xl glass-card border border-slate-800 hover:border-slate-700 group relative overflow-hidden flex flex-col justify-between`}
                  >
                    <div>
                      <div className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br ${svc.color} flex items-center justify-center mb-3.5 group-hover:scale-110 group-hover:rotate-3 transition-all`}>
                      ...
                      <p className="text-xs text-slate-100 mb-2 font-semibold">{svc.name}</p>
                      <p className="text-xs text-slate-200 leading-relaxed mb-3">{svc.desc}</p>
                    </div>
        ...
        <section
          id="process"
          className={`py-6 sm:py-8 lg:py-10 px-4 sm:px-6 relative z-10 scroll-mt-20 content-auto transition-all duration-700 ${
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
              {steps.map((s, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 sm:p-5 rounded-2xl glass-card border border-slate-800 hover:border-purple-500/50 transition-all relative group hover:-translate-y-1">
                    ...
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-purple-500/20 text-purple-200 flex items-center justify-center mb-2.5">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
              <div className="p-4 sm:p-5 rounded-2xl glass-card border border-slate-800 flex items-start gap-3.5 hover:-translate-y-1 transition-transform">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-purple-500/20 text-purple-200 flex items-center justify-center shrink-0">
              ...
              <div className="p-4 sm:p-5 rounded-2xl glass-card border border-slate-800 flex items-start gap-3.5 hover:-translate-y-1 transition-transform">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-indigo-500/20 text-indigo-200 flex items-center justify-center shrink-0">
              ...
              <div className="p-4 sm:p-5 rounded-2xl glass-card border border-slate-800 flex items-start gap-3.5 hover:-translate-y-1 transition-transform">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-blue-500/20 text-blue-200 flex items-center justify-center shrink-0">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className="p-4 sm:p-7 rounded-2xl sm:rounded-3xl bg-slate-900/90 border border-purple-500/40 text-center relative overflow-hidden shadow-2xl shadow-purple-950/40">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-3.5 text-left mb-6">
                {servicesList.map((svc) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 sm:p-4 rounded-2xl border cursor-pointer transition-all flex items-center justify-between select-none ${
                        isChecked
              ...
              <div className="pt-4 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-left">
                <div>
                  <div className="text-[11px] sm:text-xs text-slate-300 font-medium">Estimated Total Investment</div>
                ...
                <a
                  href="#contact"
                  onClick={(e) => scrollToSection(e, 'contact')}
                  className="w-full sm:w-auto px-7 py-3 rounded-xl shimmer-button text-white font-bold text-xs sm:text-sm shadow-xl shadow-purple-600/30 text-center hover:scale-[1.02] transition-all"
                >
              ...
              {faqs.map((faq, idx) => (
                ...
                >
                  <button
                    ...
                    className="w-full p-3.5 sm:p-4 text-left flex items-center justify-between gap-4 font-bold text-xs sm:text-sm text-white hover:text-purple-300 transition-colors"
                  >
                    <span>{faq.q}</span>
                    <ChevronDown
                  ...
                  {openFaq === idx && (
                    <div className="px-3.5 sm:px-4 pb-3.5 sm:pb-4 text-xs text-slate-200 leading-relaxed border-t border-slate-800/60 pt-2.5 animate-in slide-in-from-top-2 duration-200">
                      {faq.a}
                    </div>
                  )}
                </div>
        ...
        <section
          id="contact"
          className={`py-8 sm:py-12 bg-slate-950 px-4 sm:px-6 relative z-10 scroll-mt-20 content-auto transition-all duration-700 ${
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-stretch">
              ...
              <div className="order-2 md:order-1 p-5 sm:p-7 rounded-2xl sm:rounded-3xl glass-panel border border-slate-800 flex flex-col justify-between shadow-xl">
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-purple-300">Ready to Grow Your Business?</span>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mt-1.5 mb-2 sm:mb-3">Let's Build Something Great Together.</h2>
                ...
                <div className="space-y-3 text-xs sm:text-sm text-slate-200 mt-2">
                  <a
                    href="tel:+13148340021"
                    className="flex items-center gap-3.5 p-3.5 rounded-2xl glass-card border border-slate-800 hover:border-purple-500/50 transition-all group"
                  >
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-purple-500/20 text-purple-300 flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
                      <Phone className="w-4 h-4 sm:w-5 sm:h-5" />
                    </div>
                    <div>
                      <div className="text-[10px] sm:text-[11px] text-slate-400">Direct US Business Line</div>
                      <div className="text-xs sm:text-sm font-bold text-white">+1 (314) 834-0021</div>
                    </div>
                  </a>

                  <a
                    href="mailto:info@aaenterprisetech.com"
                    className="flex items-center gap-3.5 p-3.5 rounded-2xl glass-card border border-slate-800 hover:border-indigo-500/50 transition-all group"
                  >
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-indigo-500/20 text-indigo-300 flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
                      <Mail className="w-4 h-4 sm:w-5 sm:h-5" />
                    </div>
                    <div>
                      <div className="text-[10px] sm:text-[11px] text-slate-400">Official Business Email</div>
                      <div className="text-xs sm:text-sm font-bold text-white">info@aaenterprisetech.com</div>
                    </div>
                  </a>

                  <div className="flex items-center gap-3.5 p-3.5 rounded-2xl glass-card border border-slate-800">
                    ...
                    <div>
                      <div className="text-[10px] sm:text-[11px] text-slate-400">Headquarters & Global Presence</div>
              ...
              <div id="inquiry-form" className="order-1 md:order-2 p-5 sm:p-7 rounded-2xl sm:rounded-3xl glass-panel border border-slate-800 flex flex-col justify-between shadow-xl min-h-[420px]">
                {formSubmitted ? (
